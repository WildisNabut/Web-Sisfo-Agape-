...
<?php
      ...
      $Kode = $_GET['kode'];
      $query = mysqli_query($koneksi, "SELECT * FROM tugas WHERE id_tugas='$Kode'");
      $data = mysqli_fetch_array($query);
    ?>

<!-- Form untuk Edit Tugas -->
<form class="form-group" action="Proses_Edit_Tugas.php" method="post">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" id="inputNamaTugas" name="nama_tugas" value="<?php echo $data['nama_tugas']; ?>" required>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <textarea class="form-control" id="inputDeskripsi" name="deskripsi" rows="3" required><?php echo $data['deskripsi']; ?></textarea>
        </div>
    </div>
