...
<div id="Edit_Kelas">
	<div class="container">
        <h3 class="w3l-title cl"> Edit Nama Kelas </h3>
        <div class="container margin-atas">

        <?php
        $Kode = $_GET['kode'];
        $query = mysqli_query($koneksi, "SELECT * FROM kelas WHERE id_kelas = '$Kode'");
        $data = mysqli_fetch_array($query);
        ?>
        
        <form class="form-group" action="Proses_Edit_Kelas.php" method="post">
            <table class="table">
                <tr>
                    <td> ID Kelas: </td>
                    <td> <input type="text" name="id_kelas" <?php echo "value='$data[id_kelas]'"; ?> readonly> </td>
                </tr>
                
                <tr>
                    <td> Nama Kelas: </td>
                    <td> <input type="text" name="nama_kelas" <?php echo "value='$data[nama_kelas]'"; ?> required> </td>
                </tr>
            </table>
