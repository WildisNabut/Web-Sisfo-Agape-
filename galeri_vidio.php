    ...
    <div id="videoCarousel" class="carousel slide" data-ride="carousel">
      ...
      <ol class="carousel-indicators">
        <?php  
          ...
          // Menampilkan indikator berdasarkan jumlah video
          while ($data = mysqli_fetch_array($hasil)) {
              echo "<li data-target='#videoCarousel' data-slide-to='$index' class='$active'></li>";
              $active = "";
              $index++;
          }
        ?>
      ...
      <div class="carousel-inner">
        <?php  
          // Query untuk mendapatkan data video
          $tampil = "SELECT * FROM vidio";
          $hasil = mysqli_query($koneksi, $tampil);
          $active = "active";
          
          // Menampilkan setiap video dalam carousel
          while ($data = mysqli_fetch_array($hasil)) {
              $url_vidio = $data['url_vidio'];
              $embed_url = str_replace("watch?v=", "embed/", $url_vidio); // Mengganti URL YouTube dengan format embed

              echo "<div class='carousel-item $active' style='width: 100%;'>
                      <div class='card' style='width: 100%;'>
                          ...
                          <div class='card-body text-center'>
                              <iframe width='100%' height='200' src='$embed_url' frameborder='0' allow='accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture' allowfullscreen></iframe>
                          </div>
                      </div>
                    </div>";
              $active = ""; // Setelah item pertama, aktifkan item berikutnya
          }
        ?>
      </div>
